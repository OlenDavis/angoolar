...
angoolar.addProvider    = ( providerConstructor  , targetModule ) -> unless targetModule? then angoolar.modules[ targetModuleName ].addProvider    providerConstructor   for targetModuleName in targetModuleNames else angoolar.modules[ ( targetModule:: || targetModule ).$_name ].addProvider    providerConstructor
