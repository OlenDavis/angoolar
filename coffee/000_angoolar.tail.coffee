...
angoolar.addComponent   = ( component , targetModule ) -> unless targetModule? then modules[ targetModuleName ].addComponent   component  for targetModuleName in targetModuleNames else modules[ ( targetModule:: || targetModule ).$_name ].addComponent   component
