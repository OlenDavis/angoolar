...
root.BaseFilter = class BaseFilter extends root.NamedDependent
	...
	$_dependentConstructor: ->
		filter = new @constructor root.argumentsToArray arguments # This will pass all the injected dependencies to the constructor as an array in the first argument
		filter.$_filter
