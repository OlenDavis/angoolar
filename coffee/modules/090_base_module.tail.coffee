angoolar.BaseModule = class BaseModule extends angoolar.Named
	...
	addProvider   : ( provider    ) -> unless @$_module? then @providers   .push provider    else provider   ::$_addToAngular @$_module
	...
	$_addToAngular: ->
		...
		provider   ::$_addToAngular @$_module for provider    in @providers
