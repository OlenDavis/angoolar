/**
 * @license AngularJS v1.2.0-804ad99
 ...
 */
var version = {
  full: '1.2.0-804ad99',    // all of these placeholder strings will be replaced by grunt's
...
function $CompileProvider($provide) {
  ...
  this.$get = [
    ...
    function compileNodes(nodeList, transcludeFn, $rootElement, maxPriority, ignoreDirective,
      ...
      function compositeLinkFn(scope, nodeList, $rootElement, boundTranscludeFn) {
        ...
        for(i = 0, n = 0, ii = linkFns.length; i < ii; n++) {
          ...
          if (nodeLinkFn) {
            if (nodeLinkFn.scope) {
              childScope = scope.$new(isObject(nodeLinkFn.scope) && !nodeLinkFn.notIsolated);
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
        ...
        if (directiveValue = directive.scope) {
          ...
          if (!directive.templateUrl) {
            assertNoDuplicate('new/isolated scope', newIsolateScopeDirective, directive,
                              $compileNode);
            if (isObject(directiveValue) && !directive.notIsolated) {
      ...
      nodeLinkFn.notIsolated = newScopeDirective && newScopeDirective.notIsolated;
            ...
            switch (mode) {
              ...
              default:
                throw $compileMinErr('iscp',
                    ...
                    " Definition: {... {1}: '{2}' ...}",
                    newScopeDirective.name, scopeName, definition);
            }
          });
        }
